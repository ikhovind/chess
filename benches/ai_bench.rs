...
pub fn criterion_benchmark(c: &mut Criterion) {
    let board = Game::from_fen("rn2kb1r/p3qppp/2p2n2/1N2p1B1/2B1P3/1Q6/PPP2PPP/R3K2R b KQkq - 0 10");
    let base = Game::from_fen(BASE_POS).make_move(&Move::new_move(12, 28, false));
    ...
    group.bench_function("morphy-duke", |b| b.iter(|| eval(board.clone(), 4, false)));
    group.bench_function("base-pos", |b| b.iter(|| eval(base.clone(), 4, false)));
    group.bench_function("complicated", |b| b.iter(|| eval(complicted.clone(), 4, false)));
